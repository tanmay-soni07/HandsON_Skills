...
Programming Languages: Java, PL/SQL, TDD (JUnit5, Mockito), SLF4J.
Products and Frameworks: Spring Core, Spring Data JPA, Hibernate, Spring REST, Microservices (Spring Boot 3, Spring Cloud), React.
Platforms & GenAI: GIT, CI/CD, Docker, Cloud Fundamentals, GenAI (GitHub Copilot).
---
...
Navigate to the specific week and project folder (e.g., `cd Week-4/account`).
Run the application using Maven:
```bash
   mvn spring-boot:run
   ```
Running the Frontend Applications
Navigate to the React project folder (e.g., `cd Week-5/myfirstreact`).
